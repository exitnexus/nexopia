...
class User < Cacheable
	relation_multi_cached :galleries, :userid, Gallery::GalleryFolder, "ruby_galleries"
	def galleries_sorted_by_name
		return self.galleries.sort_by {|gallery| gallery.name.upcase}
	end
end
