...
Throughout this document the terms 'site', 'us', 'we' and 'our' refer to Nexopia.

Throughout this document the terms ‘your’, ‘you’ and ‘user’ refer to parties other than Nexopia governed by this contract.
...
Nexopia allows, but does not encourage users in any way to submit for distribution any personal information over the Internet.


EXCLUSION OF LIABILITY

<font style='background-color: yellow'>NEXOPIA WILL NOT BE HELD LIABLE TO OR BY ANY PARTY GOVERNED BY THIS CONTRACT FOR ANY DAMAGES OF ANY KIND INCLUDING BUT NOT LIMITED TO DIRECT, INDIRECT, SPECIAL OR OTHER CONSEQUENTIAL OR INCIDENTAL DAMAGES, LOST PROFITS, BUSINESS INTERRUPTION OR OTHERWISE, ARISING DIRECTLY OR INDIRECTLY FROM THE USE OF THIS WEBSITE OR NEXOPIA SERVICES, EVEN IF SUCH DAMAGES ARE FORESEEABLE OR NEXOPIA IS EXPRESSLY ADVISED OF THE POSSIBILITY OF SUCH DAMAGES AND REGARDLESS OF THE BASIS ON WHICH A CLAIM FOR DAMAGES IS MADE.

NEXOPIA SHALL NOT BE HELD LIABLE FOR THE LOSS OF ANY PERSONAL INFORMATION SUBMITTED BY USERS FOR DISTRIBUTION ON NEXOPIA.COM SERVICES. USERS SUBMIT THIS INFORMATION AT THEIR OWN RISK.

BY PARTICIPATING IN ANY OFFLINE NEXOPIA EVENT, YOU AGREE TO RELEASE AND HOLD NEXOPIA HARMLESS FROM ANY AND ALL LOSSES, DAMAGES, RIGHTS, CLAIMS, AND ACTIONS OF ANY KIND INCLUDING, WITHOUT LIMITATION, PERSONAL INJURIES, DEATH, AND PROPERTY DAMAGE, EITHER DIRECTLY OR INDIRECTLY RELATED TO OR ARISING FROM YOUR PARTICIPATION IN ANY SUCH OFFLINE NEXOPIA EVENT.</font>
...
You the User act in the capacity of author and publisher of any content you, the User, produce and make publicly available through the use of the Nexopia.com service.

Nexopia.com, with regards to this user generated content, acts solely in the capacity as a distributor, and assumes no responsibility of any kind whatsoever for such content.


PROPRIETARY RIGHTS OF NEXOPIA CONTENT

Nexopia owns and retains other proprietary rights in the Nexopia site and service. The site contains the copyrighted material, trademarks and other proprietary information of Nexopia. Except for information which is in the public domain or for which you have been given express written permission, you may not copy, modify, publish, transmit, distribute, perform, display, or sell any such proprietary information.


CONTENT PRODUCED FOR DISTRIBUTION ON NEXOPIA

You understand and agree that Nexopia reserves the right to delete any accounts, content, messages, photos or profiles (collectively, 'Content') that in the sole judgment of Nexopia violate the Terms of Use or which might be offensive, illegal, or that might violate the rights, harm, or threaten the safety of Nexopia and/or its Members.

You are solely responsible for the Content that you publish or display (hereinafter, 'post') on the Nexopia service, or transmit to other Nexopia Members.

By producing Content for distribution in any public area of Nexopia, you automatically grant, and you represent and warrant that you have the right to grant, to Nexopia, and other Nexopia Members, an irrevocable, perpetual, non-exclusive, worldwide license to use any uploaded content for personal non-profit use.

By producing Content for distribution in any public area of Nexopia, you automatically grant, and you represent and warrant that you have the right to grant, to Nexopia the right to use all uploaded Content for promotional use in any medium without Nexopia providing any notice of use or compensation of any kind.

<font style='background-color: yellow'>The following is a partial list of the kind of Content that is illegal or prohibited on the Site. Nexopia will investigate and take appropriate action in its sole discretion against anyone who violates this provision, including without limitation, removing the offending communication from the Service, terminating the Membership of such violators, as well as other legal actions</font>. It includes Content that:
<ul>
<li>is patently offensive to the online community, including but not limited to Content that promotes racism, bigotry, hatred or physical harm of any kind against any group or individual; harasses or advocates harassment of another person; involves the transmission of 'junk mail', 'chain letters' or unsolicited mass mailing or 'spamming'; promotes information that you know is false, misleading or promotes illegal activities or conduct that is abusive, threatening, obscene, or defamatory;
...
<li>contains restricted or password only access pages, or hidden pages or images (those not linked to or from another accessible page) ; displays pornographic or sexually explicit material of any kind;

<li>provides material that exploits people under the age of 18 in a sexual or violent manner, or solicits personal information from anyone under 18; provides instructional information about illegal activities such as making or buying illegal weapons, violating someone’s privacy, or providing or creating computer viruses; solicits passwords or personal identifying information for commercial or unlawful purposes from other users; and engages in commercial activities and/or sales without our prior  express written consent such as contests, sweepstakes, barter, advertising, and pyramid schemes.
</ul>
...
<font style='background-color: yellow'>You are solely responsible for your interactions with other Nexopia Members.</font> Nexopia reserves the right, but has no obligation, to monitor disputes between you and other Members.


JURISDICTION

The laws in force in the province of Alberta, Canada, will govern this contract, terms, conditions and any claims you make against Nexopia. You agree that any action at law or in equity arising out of or relating to these disclaimers, terms and conditions will be filed solely in the courts located in the province of Alberta, and you hereby consent and submit to the personal jurisdiction of such courts for the purpose of litigating such action, notwithstanding your place of residence.

This agreement is made, executed, and delivered in Edmonton, Alberta, Canada, any controversy arising from, or in relation to this Agreement shall be governed by and construed in accordance to the domestic laws of the Province of Alberta, Canada. The parties hereto and hereby agree that any disputes arising from this agreement shall be submitted to, and be subject to the to the jurisdiction of the courts of the Province of Alberta which shall have exclusive jurisdiction in the event of any dispute hereunder. Furthermore, the parties hereby irrevocably submit and attorn the jurisdiction of such courts to finally adjudicate and action arising out of this agreement.

Additionally, the parties hereto hereby agree that the United Nations Convention on Contracts for the International Sale of Goods does not apply to this Agreement and is strictly excluded.


REPRESENTATIONS AND WARRANTIES

You represent and warrant that all information that you provide in the Nexopia Application Form is personal to you and that all images or photographs submitted by you are images or photographs of you or images of which you own the rights to, or have been granted the express right to publish and distribute.


INDEMNIFICATION

You will indemnify and hold harmless Nexopia  for and against any and all actions, costs, damages and reasonable attorney fees arising out of your use of the Nexopia services, your breach of any of these terms and conditions or your infringement of any third party’s intellectual property rights.


GENERAL

Nexopia may amend these Website Terms of Use at any time. Accordingly, you should periodically re-visit these terms to review the then-current Website Terms of Use governing your use of this website. Your continued use of the services provided through the Nexopia website constitutes your acceptance of the then-current Website Terms of Use. If any part of these Website Terms of Use is deemed unlawful, void or unenforceable, then that part is severable and will not affect the validity and enforceability of the remaining disclaimers, terms and conditions. Nexopia reserves the right at any time to begin charging for access to this website and its services.
...
The Services offered by the site are intended for personal use only and not for commercial use (without the express written permission from Nexopia).

Only post content that you have the rights to display or use. All content you post remains your property, although, in order to use the Services offered on the site, you give both Nexopia, and other users of the site, the right to use your content.

All other content is the property of Nexopia or our suppliers or licensors. Nexopia content can be used for personal use when on the site, but not anywhere else without Nexopia's written permission. 

Nexopia does not monitor your content or that of a third party, but reserves the right to refuse or remove any content that violates these Terms. Nexopia can also, at its sole discretion, take any steps it deems necessary to deal with a violation of these Terms.

Nexopia will assist law enforcement personnel with suspected or alleged illegal user content, including, but not limited to private messaging.

Engaging in any illegal or objectionable behaviour or posting of any illegal or prohibited material (i.e. harassment, racist comments, violent messages, nudity...) on the site may result in the termination of your membership, or result in possible legal action.

Nexopia has no control over content hosted on other Internet sites. Just because a link, for example, appears on our site does not mean Nexopia approves or endorses that content. 

Nexopia cannot be held responsible for what others do with the information you post on the Service, so be cautious about the information, especially personal information, you post about yourself or others.
...
<b>Proprietary Rights in Content on Nexopia.com</b>

<b><i>Your Content</i></b>
...
<ul><li>You own Your Content posted, displayed or published by you on or through the Nexopia Services and Nexopia Website or you otherwise have the right to grant to us the License set forth in this section; and
...
<ul><li>is patently offensive to the online community, such as Content that promotes racism, bigotry, hatred or physical harm of any kind against any group or individual; 
<li>harasses or advocates harassment of another person; 
<li>involves the transmission of "junk mail," "chain letters," "spam," or any other unsolicited mass mailing, e-mailing, or other communication; 
<li>results in the falsification of IP address information, modification of message headers to conceal your identity or to impersonate others, or is for the purpose of circumventing this Code of Conduct;
<li>interferes with or disrupts the Services or the servers or networks used to provide or receive the Services or you disobey any requirement, procedure, policies and regulation of any networks used to provide and receive the Service;
<li>includes any information that (1) you know is false or misleading, (2) promotes illegal activities or conduct that is abusive, or (3) is threatening, obscene, defamatory, or libelous;
<li>constitutes or includes any illegal or unauthorized copy of another person's copyrighted or copyrightable work, including, but not limited to (1) pirated computer programs or links to them, (2) information that circumvents manufacturer-installed copy-protect devices,  or (3) pirated music or links to pirated music files; 
<li>displays pornographic or sexually explicit material of any kind; 
<li>includes material that exploits people under the age of 18 in a sexual or violent manner, or is intended to solicit personal information from anyone under 18;
<li>provides instructional information about illegal activities such as making or buying illegal weapons, violating someone's privacy, or providing or creating computer viruses or other harmful code; 
<li>solicits passwords or personally identifying information for commercial or unlawful purposes from other Members; 
<li>covers or obscures the banner advertisements on your personal profile page, or any Nexopia.com web page via  HTML/CSS or any other means;
<li>constitutes or includes any promotion, sales or other commercial activity such as contests, sweepstakes, barter, advertising, or pyramid schemes; or 
<li>solicits people you don't know to add you or accept you as a friend on the Service. 
</ul>
...
<b>Privacy and Use of Information</b>
...
<ul><li>YOUR USE OF THE WEBSITE AND SERVICES IS AT YOUR SOLE RISK. THE WEBSITE AND SERVICES ARE PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS.  NEXOPIA.COM EXPRESSLY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO THE IMPLIED WARRANTIES OR CONDITIONS OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT.
<li>NEXOPIA.COM MAKES NO WARRANTY THAT (i) THE SERVICES WILL MEET YOUR REQUIREMENTS, (ii) THE SERVICES OR ANY SOFTWARE PROVIDED TO YOU THROUGH THE SERVICES WILL BE UNINTERRUPTED, TIMELY, SECURE, OR ERROR-FREE, (iii) THE RESULTS THAT MAY BE OBTAINED FROM THE USE OF THE SERVICES WILL BE ACCURATE OR RELIABLE, (iv) THE QUALITY OF ANY  SERVICES, INFORMATION, OR OTHER MATERIAL PURCHASED OR OBTAINED BY YOU THROUGH THE SERVICES WILL MEET YOUR EXPECTATIONS, AND (V) ANY ERRORS IN SOFTWARE AND ANY SOFTWARE PROVIDED TO YOU THROUGH THE SERVICES WILL BE CORRECTED.
<li>ANY MATERIAL DOWNLOADED OR OTHERWISE OBTAINED THROUGH THE USE OF THE SERVICES IS DONE AT YOUR OWN DISCRETION AND RISK AND THAT YOU WILL BE SOLELY RESPONSIBLE FOR ANY DAMAGE TO YOUR COMPUTER SYSTEM OR LOSS OF DATA OR OTHER LIABILITY THAT RESULTS FROM THE DOWNLOAD OF ANY SUCH MATERIAL.
<li>NO ADVICE OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED BY YOU FROM NEXOPIA.COM OR THROUGH OR FROM THE SERVICES SHALL CREATE ANY WARRANTY NOT EXPRESSLY STATED IN THESE TERMS.
</ul>
