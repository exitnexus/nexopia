...
var pathToImages = 'include/calendar/images/';	// Relative to your HTML file
...
var selectBoxHighlightColor = '#0808D6'; // Highlight color of select boxes
...
function updateHourDiv()
{
	...
	for(var no=1;no<hourItems.length-1;no++){
		var prefix='';
		if((currentHour/1 -6 + no) < 10)prefix='0';
		hourItems[no].innerHTML = prefix +  (currentHour/1 -6 + no);	
...
function initCalendar()
{
	if(MSIE){
		...
		iframeObj.style.backgroundColor = '#0000FF';
