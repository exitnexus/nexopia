...
//general
	$skindata['name']        = 'mindfield'; //name of the skin, used for ruby layer translation
...
//non-frames header
	$skindata['headerpic'] = "pinkstars_header.jpg"; //name of the header background (1600xVAR, assume only 750 width visible)
	$skindata['headerheight'] = 90;           //height of the header

//frames header
	$skindata['headersmall'] = "pinkstars_header60.jpg"; //header for 800x600  users (1600x60, assume only 300x60 visible)
	$skindata['headerbig']   = "pinkstars_header.jpg";   //header for 1024x768 users (1600x90, assume only 300x90 visible)
	$skindata['headerplus']  = "pinkstars_header60.jpg"; //header for plus     users (1600x60, assume only 750x60 visible)
	$skindata['headernorepeat'] = "background-repeat: no-repeat;";
	$skindata['headerbackgroundcolor'] = "#CC257D";
...
//menu
	...
	$skindata['menuspacer'] = "#2e2e2e"; //separater between menus, either a image or a colour (starting with #)
