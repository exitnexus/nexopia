...
//general
	$skindata['name']        = 'nouveau'; //name of the skin, used for ruby layer translation
...
//non-frames header
	$skindata['headerpic'] = "nouveau_header.jpg"; //name of the header background (1600xVAR, assume only 750 width visible)
	$skindata['headerheight'] = 90;           //height of the header

//frames header
	$skindata['headersmall'] = "nouveau_header60.jpg"; //header for 800x600  users (1600x60, assume only 300x60 visible)
	$skindata['headerbig']   = "nouveau_header.jpg";   //header for 1024x768 users (1600x90, assume only 300x90 visible)
	$skindata['headerplus']  = "nouveau_header60.jpg"; //header for plus     users (1600x60, assume only 750x60 visible)
...
//menu
	...
	$skindata['menuspacer'] = "#3e3e3e"; //separater between menus, either a image or a colour (starting with #)
...
//body
	$skindata['mainbg'] = "nouveau_body.jpg"; //background image for the main body, if empty or a colour, use the one from the css
