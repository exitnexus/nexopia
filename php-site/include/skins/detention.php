...
//general
	$skindata['name']        = 'detention'; //name of the skin, used for ruby layer translation
...
//non-frames header
	$skindata['headerpic'] = "wood_header.jpg"; //name of the header background (1600xVAR, assume only 750 width visible)
	$skindata['headerheight'] = 90;           //height of the header

//frames header
	$skindata['headersmall'] = "wood_header60.jpg"; //header for 800x600  users (1600x60, assume only 300x60 visible)
	$skindata['headerbig']   = "wood_header.jpg";   //header for 1024x768 users (1600x90, assume only 300x90 visible)
	$skindata['headerplus']  = "wood_header60.jpg"; //header for plus     users (1600x60, assume only 750x60 visible)
	$skindata['headernorepeat'] = "background-repeat: no-repeat;";
	$skindata['headerbackgroundcolor'] = "#110906";
...
//menu
	...
	$skindata['menuspacer'] = "#311b0e"; //separater between menus, either a image or a colour (starting with #)
...
//body
	$skindata['mainbg'] = "wood_body.jpg"; //background image for the main body, if empty or a colour, use the one from the css
