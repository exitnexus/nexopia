...
//general
	$skindata['name']        = 'newblack'; //name of the skin, used for ruby layer translation
...
//non-frames header
	$skindata['headerpic'] = "90x1600_header.jpg"; //name of the header background (1600xVAR, assume only 750 width visible)
	$skindata['headerheight'] = 90;           //height of the header

//frames header
	$skindata['headersmall'] = "60x1600_header.jpg"; //header for 800x600  users (1600x60, assume only 300x60 visible)
	$skindata['headerbig']   = "90x1600_header.jpg";   //header for 1024x768 users (1600x90, assume only 300x90 visible)
	$skindata['headerplus']  = "60x1600_header.jpg"; //header for plus     users (1600x60, assume only 750x60 visible)
...
//menu
	...
	$skindata['menuspacer'] = "#939697"; //separater between menus, either a image or a colour (starting with #)
