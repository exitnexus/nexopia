...
//general
	$skindata['name']        = 'carbon'; //name of the skin, used for ruby layer translation
...
//non-frames header
	...
	$skindata['headerheight'] = 97;           //height of the header
...
//menu
	$skindata['menupic'] = "menu.gif"; //background for the menus, either a image or a colour (starting with #)
...
//body
	$skindata['mainbg'] = "bg.jpg"; //background image for the main body, if empty or a colour, use the one from the css
