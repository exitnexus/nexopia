...
//general
	$skindata['name']        = 'rockstar'; //name of the skin, used for ruby layer translation
...
//menu
	...
	$skindata['menuspacer'] = "#ffffff"; //separater between menus, either a image or a colour (starting with #)
