...
//general
	$skindata['name']        = 'fallingsky'; //name of the skin, used for ruby layer translation
...
//non-frames header
	$skindata['headerpic'] = "fallingsky_header.png"; //name of the header background (1600xVAR, assume only 750 width visible)
	$skindata['headerheight'] = 90;           //height of the header

//frames header
	$skindata['headersmall'] = "fallingsky_header60.png"; //header for 800x600  users (1600x60, assume only 300x60 visible)
	$skindata['headerbig']   = "fallingsky_header.png";   //header for 1024x768 users (1600x90, assume only 300x90 visible)
	$skindata['headerplus']  = "fallingsky_header60.png"; //header for plus     users (1600x60, assume only 750x60 visible)
	$skindata['headernorepeat'] = "background-repeat: no-repeat;";
	$skindata['headerbackgroundcolor'] = "#143237";
...
//menu
	...
	$skindata['menuspacer'] = "#0b2531"; //separater between menus, either a image or a colour (starting with #)
...
//body
	$skindata['mainbg'] = "fallingsky_body.png"; //background image for the main body, if empty or a colour, use the one from the css
