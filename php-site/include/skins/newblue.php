...
//general
	$skindata['name']        = 'newblue'; //name of the skin, used for ruby layer translation
...
//menu
	$skindata['menupic'] = "#0353A2"; //background for the menus, either a image or a colour (starting with #)
