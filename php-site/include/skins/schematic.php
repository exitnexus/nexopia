...
//general
	$skindata['name']        = 'schematic'; //name of the skin, used for ruby layer translation
...
//non-frames header
	$skindata['headerpic'] = "headerbig.png"; //name of the header background (1600xVAR, assume only 750 width visible)
...
//menu
	$skindata['menupic'] = "menubg.png"; //background for the menus, either a image or a colour (starting with #)
	$skindata['menuheight'] = 25;        //height of the menu (generally the pic from above)
	$skindata['menudivider'] = " | ";    //separater between menu items
	$skindata['menuspacer'] = "#c7c7c7"; //separater between menus, either a image or a colour (starting with #)
	$skindata['menuspacersize'] = 0;     //size of the spacer
	$skindata['menugutter'] = "#000"; //gutter below the top menu, either a image or a colour (starting with #)
