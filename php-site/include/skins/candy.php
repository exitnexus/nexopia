...
//general
	$skindata['name']        = 'candy'; //name of the skin, used for ruby layer translation
...
//menu
	...
	$skindata['menugutter'] = "#89c87a"; //gutter below the top menu, either a image or a colour (starting with #)
