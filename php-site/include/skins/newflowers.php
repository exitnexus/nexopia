...
//general
	$skindata['name']        = 'newflowers'; //name of the skin, used for ruby layer translation
...
//menu
	...
	$skindata['menugutter'] = "#af2177"; //gutter below the top menu, either a image or a colour (starting with #)
