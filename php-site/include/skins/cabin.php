...
//general
	$skindata['name']        = 'cabin'; //name of the skin, used for ruby layer translation
...
//menu
	$skindata['menupic'] = "#f5f5f5"; //background for the menus, either a image or a colour (starting with #)
