...
//general
	$skindata['name']        = 'winter'; //name of the skin, used for ruby layer translation
...
//menu
	$skindata['menupic'] = "#d6e3ee"; //background for the menus, either a image or a colour (starting with #)
