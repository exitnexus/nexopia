...
//general
	$skindata['name']        = 'abacus'; //name of the skin, used for ruby layer translation
...
//menu
	...
	$skindata['menuspacer'] = "#e0eaee"; //separater between menus, either a image or a colour (starting with #)
