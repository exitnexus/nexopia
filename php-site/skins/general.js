...
var smileycols = 4;
var smileyrows = 6;
var smileyloc = "/images/smilies/"; //reset with a smileyloc();
...
function checkProfileLength(){
	...
	if(document.editbox.signiture.value.length > siglength)
		formErrors += "Your Signiture is " + (document.editbox.signiture.value.length - siglength) + " characters too long\n";
