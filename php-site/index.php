<?
	...
	$leftBlocks = array('incLoginBlock','incSpotlightBlock','incSortBlock','incTopGirls','incTopGuys','incNewestMembersBlock','incRecentUpdateProfileBlock'); // 'incSkyAdBlock',
	...
	$news = $cache->hdget("news$news", 300, 'getNews');
...
<br>
<b>What Nexopia does to protect its users:</b>
<ul>
...
<br>
We're proud to work with Edmonton Police Service and Calgary Police Service to help keep our users safe. Any suggestions are welcome.<br>
<br>
...
function getArticles(){
	...
	$result = $db->prepare_query("SELECT id, time, author, authorid, category, title, text, comments FROM articles WHERE moded='y' && time >= # ORDER BY time DESC LIMIT 4", time() - 86400*600);
